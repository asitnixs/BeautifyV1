...
<style lang="scss">
  ...
  .button-add {
    ...
    font-size: 12px;
    color: $clickgui-text-color;
    background-color: $clickgui-main-color-1;
    border: none;
    padding: 6px 10px;
    border-radius: 3px;
    width: 100%;
    ...
    &:hover {
        background-color: color.adjust(color.adjust($clickgui-main-color-1, $saturation: -30%), $lightness: -10%);
    }
  }
  ...
  .value {
    ...
    color: $clickgui-text-color;
    border: none;
    border-bottom: solid 2px $clickgui-main-color-1;
    padding: 6px;
    border-radius: 3px;
